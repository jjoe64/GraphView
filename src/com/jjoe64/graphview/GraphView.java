...
abstract public class GraphView extends LinearLayout {
    ...
    private GraphViewDataInterface[] _values(int idxSeries) {
        ...
        synchronized (graphSeries.get(idxSeries).values) {
    ...
    /**
     * Add a series of data to render in the graph. The graph automatically redraws once the data has been added.
     *
     * @param series A series containing the data to be shown in the graph
     */
    ...
    protected String formatLabel(double value, boolean isValueX) {
        ...
        if (numberformatter[i] == null) {
            ...
            } else if (highestvalue - lowestvalue < 0.1) {
     ...
     *
     * @param integerLabels Whether to only use integers in the labels
     */
     ...
     *
     * @param increment Value to increment each horizontal label with
     */
     ...
     *
     * @param increment Value to increment each vertical label with.
     */
     ...
     *
     * @param customLabelFormatter The custom label formatter for this graph view.
     */
     ...
     *
     * @param disableTouch Whether touches should be disregarded or not. True to disable.
     */
     ...
     *
     * @param style Style for the graphView
     */
     ...
     * If you want to disable the manual Y-axis, call this method with false.
     */
    ...
    /**
     * If you want to disable the manual Y-axis maximum bound, call this method with false.
     */
    ...
    /**
     * If you want to disable the manual Y-axis minimum bound, call this method with false.
     */
     ...
     *
     * @param max Maximum Y-axis bound
     * @param min Minimum Y-axis bound
     */
    ...
    /**
     * Set manual Y-axis maximum limit
     * @param max The maximal Y-axis bound
     */
     ...
     * @param min Minimal Y-axis bound
     */
    ...
    /**
     * Set whether this GraphView should be scalable. This also force enables scrolling (scrollable = true)
     *
     * @param scalable Whether this GraphView should listen to scale gestures from the user.
     */
    ...
    /**
     * The user can horizontally scroll the through the graph.
     * This is only useful if you use a viewport {@link #setViewPort(double, double)} which doesn't displays all data.
     */
    ...
    /**
     * Set the title of GraphView
     *
     * @param title Title to display over the graph
     */
    ...
    /**
     * Set the static vertical labels (from top to bottom)
     *
     * @param verlabels If null, labels are generated automatically
     */
    ...
    /**
     * Set the viewport for the graph.
     *
     * @param start X-value used for the viewport
    ...
    /**
     * Set whether horizontal labels are drawn or not.
     */
    ...
    /**
     * Set whether vertical labels are drawn or not.
     */
